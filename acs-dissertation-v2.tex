...
\end{tabular}
\end{adjustbox}
\caption{Challenges faced by methods. A check mark indicates the method overcomes of the respective pitfall.}\label{tab:conceptual_pits}
\end{table}
%TC:endignore
\begin{itemize}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.4,trim={2.3cm 1cm 2.5cm 0}, clip]{images/GP/gp_circles_scatter_200_big_.png}
