...
First we give a summary of our findings, highlighting the empirical capacities of the 3 approaches we trialed. A summary of the results can be found in Figure \ref{fig:comp_exp}. The main practical milestones we consider when evaluating the methods are:
