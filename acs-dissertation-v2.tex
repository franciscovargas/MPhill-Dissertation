...
Finally, we select two toy datasets (one unimoda to unimodal and one unimodal to bimodal) which all methods managed to fit visually and construct a hypothesis test in order to compare the methods against each other in a more statistically sound framework. 
\begin{figure}[t]
    \centering
...
\begin{figure}
    ...
    \caption{Loss per epoch for fitted unimodal SB using the DDE method.}
...
\begin{figure}
    ...
    \caption{ Fitted SB trajectories using the DDE method for unimodal to trimodal data using DDE.  }
